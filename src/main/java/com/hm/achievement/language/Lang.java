...
public enum Lang {
    ...
    AACH_COMMAND_GIVE("aach-command-give", "Give the achievement ACH to the &7player NAME."),
    ...
    LIST_AMOUNT("list-amount", "Amount:"),
    ...
    LIST_DISTANCE("list-distance", "Distances Travelled"),
