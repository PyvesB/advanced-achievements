...
public class GenerateCommand extends AbstractCommand {
	...
	public void extractConfigurationParameters() {
		...
		langAdvancementsGenerated = pluginHeader + Lang.get(CmdLang.ADVANCEMENTS_GENERATED, langConfig);
		langMinecraftNotSupported = pluginHeader + Lang.get(CmdLang.MINECRAFT_NOT_SUPPORTED, langConfig);
	}
