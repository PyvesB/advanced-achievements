...
public class AddCommand extends AbstractParsableCommand {
	...
	public void extractConfigurationParameters() {
		...
		langErrorValue = pluginHeader + Lang.get(CmdLang.ERROR_VALUE, langConfig);
		langStatisticIncreased = pluginHeader + Lang.get(CmdLang.STATISTIC_INCREASED, langConfig);
