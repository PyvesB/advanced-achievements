...
public class ReloadCommand extends AbstractCommand {
	...
	public void extractConfigurationParameters() {
		langConfigReloadFailed = pluginHeader + Lang.get(CmdLang.CONFIGURATION_RELOAD_FAILED, langConfig);
		langConfigSuccessfullyReloaded = pluginHeader + Lang.get(CmdLang.CONFIGURATION_SUCCESSFULLY_RELOADED, langConfig);
	}
