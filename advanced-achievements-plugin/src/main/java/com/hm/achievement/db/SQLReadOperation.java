...
/**
 * Class used to perform read operations to the database and automatically retry
...
public interface SQLReadOperation<T> {
	...
	/**
	 * Calls {@code performRead} repeatedly until the read succeeds or
	 * {@code MAX_ATTEMPTS} is reached, in which case a runtime exception is thrown.
	 *
