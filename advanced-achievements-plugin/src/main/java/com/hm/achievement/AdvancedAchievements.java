...
/**
 * Bukkit instantiates an instance of this class and calls the onEnable and
 * onDisable methods when relevant. This class is the root of the dependency
 * graph constructed with Dagger and is used to bind the instance created by
 * Bukkit with the rest of the plugin modules. It delegates the actual enabling
 * and disabling operations to the PluginLoader class.
 * 
 * @author Pyves
 */
public class AdvancedAchievements extends JavaPlugin {
	...
	public void onEnable() {
		...
		// DaggerAdvancedAchievementsComponent is generated by Dagger. Add
		// target/generated-sources/annotations to your
		// build path if the IDE complains here. In any case this will not actually
		// prevent you from compiling.
...
@Singleton
@Component(modules = {CleanableModule.class, CommandModule.class, ConfigModule.class, DatabaseModule.class,
		ReloadableModule.class, ServerVersionModule.class, UpdateCheckerModule.class})
